...
document.getElementById("what_to_draw").innerHTML = element_of_array;
...
function draw() {
        if(drawn_sketch == sketch){
            answer_holder = answer_holder + "set";
            score = score + 1;
            document.getElementById("number_score").innerHTML = score;
...
function check_sketch() {
    ...
    document.getElementById("timer_number").innerHTML = timer_counter;
